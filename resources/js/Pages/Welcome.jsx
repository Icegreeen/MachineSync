          ...
          <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
            ...
            <main className="mt-6 flex flex-col md:flex-row items-center justify-center w-full">
              <div className="min-h-screen flex flex-col p-4 w-full">
                <div className="mb-10">
                  <h1 className="text-4xl text-black font-bold mb-4">Unlock the Power of Our SaaS Platform</h1>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:space-x-10 w-full">
                  ...
                  <div className="mt-16 md:mt-0 md:ml-10">
                    <img src="https://private-user-images.githubusercontent.com/56550632/329281845-f7b21447-d213-4f97-a3d4-9f4238a05b57.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..FkUZCV6KVkF9qSlSWbeI3t93ZxS_FlcjZ3Tm-YK4m4o" alt="Example" className="w-full max-w-md mx-auto rounded-lg shadow-md" />
                  </div>
                </div>
              </div>
            </main>
